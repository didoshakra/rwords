  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        level1: "var(--color-pCol9)",
        level2: "var(--color-pCol8)",
        level3: "var(--color-pCol8)",
        level4: "var(--color-pCol7)",
        level5: "var(--color-pCol7)",
        level0D: "var(--color-pCol2)",
        level1D: "var(--color-pCol9)",
        level2D: "var(--color-pCol8)",
        level3D: "var(--color-pCol8)",
        level4D: "var(--color-pCol7)",
        level5D: "var(--color-pCol7)",
        ...
        // fBgD: "#64748b", //  --color-pCol6: #475569;
        tabTrBgSelHov: "var(--color-pCol11)",
        tabTrBgSelHovD: "var(--color-pCol11)",
        // tabTr1 -------------------------------
        tabTr1On: "var(--color-pCol9)",
        tabTr1OnD: "var(--color-pCol0)",
        tabTr1OnHov: "var(--color-pCol0)",
        ...
        tabTr2On: "var(--color-pCol0)",
        tabTr2OnD: "var(--color-pCol3)",
        tabTr2OnHov: "var(--color-pCol0)",
