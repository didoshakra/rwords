...
export default function WordsPage() {
  ...
  return (
    <main className="p-6 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">Слова2/2а рівні/втрачає фокус при переміщенні</h1>
        ...
        <table className="w-full border-collapse">
          ...
          <tbody>
            ...
            {sections.map((section) => {
              ...
              const sectionWords = words.filter((w) => sectionTopics.some((t) => t.id === w.topic_id))
