...
const pageAboutMe_text1 = `Я є ентузіастом-розробником програмного забезпечення старшого(пенсійного) покоління, який "убиває" свій вільний час, вивчаючи нові технології в програмуванні. Цей сайт і застосунок - це спроба зробити щось корисне і, можливо, не тільки для себе, використовуючи: JS, React, NextJS, React Native, PostgreSQL, MySQL,...  і інші "примочки".`
