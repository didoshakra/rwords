...
const pageAboutMe_text1 = `Я є ентузіастом-розробником програмного забезпечення старшого(пенсійного) покоління, який "убиває" свій вільний
час, вивчаючи нові технології в програмуванні. Цей сайт - це спроба зробити щось корисне і, можливо, не тільки для себе, використовуючи: JS, React, NextJS, PostgreSQL ...  і інші "примочки".`
const pageAboutMe_text2 = `Я створив мобільний додаток RWords для вивчення іноземних слів з голосовим керуванням, персональними словниками і оцінкою знань. І хотів би мати можливість ділитися контентом(словами, виразами, реченнями) з іншими користувачами. А також отримати допомогу у вдосконаленні додатку і в створені контенту. Цей сайт - це спроба реалізувати цю ідею.`
const pageAboutMe_text3 = `
...
const About = () => {
  return (
    <section className="flex flex-col space-y-4 px-4 py-6 max-w-5xl mx-auto text-pText dark:text-pTextDtext-center font-body">
      {/* <h1 className="text-h1Text text-xl sm:text-2xl lg:text-3xl italic font-bold mb-4">Про сайт і додаток RWords</h1> */}
