  ...
  return (
    <main className="px-4 py-8 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <ScreenBlock title="🧭 Основні екрани1">
        ...
        <ScreenBlock title="📋 Список слів-кнопки" img="/rwords_screens/words_list_buttons1.jpg">
          <h4 className="font-bold mb-1">Тут ви можете</h4>
          <ul className="list-disc pl-10 mb-4">
        ...
        <ScreenBlock title="📋🔀 Список слів-переміщення" img="/rwords_screens/words_list1.jpg">
          <h4 className="font-bold mb-1">Тут ви можете</h4>
          <ul className="list-disc pl-10 mb-4">
