    ...
    <main className="px-4 py-8 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <section className="mb-6">
        <h2 className="text-h2Text text-xl sm:text-2xl lg:text-3xl font-semibold mb-2 text-center">
          📖 RWords — платформа для вивчення іноземних слів і фраз, яка складається з 2-х частин: мобільний застосунок
          на Android RWords і сайт RWords.
        </h2>
        ...
        <p className="text-base sm:text-lg lg:text-xl  mb-2">
          ...
          підвищує ефективність процесу навчання.
        </p>
        <p className="text-base sm:text-lg lg:text-xl  mb-2">
          У застосунку ви можете: прослуховувати слова, вирази та речення з перекладом на вибрану мову із вибраних вами
          списків. Під час прослуховування ви можете оцінювати свої знання натискаючи кнопки «Знаю» / «Не знаю», чи
          подаючи аналогічні команди голосом. Це дає можливість при виборі списків для прослуховування формувати
          персональні списки. Слова, позначені як «Знаю», можна виключати з подальшого відтворення. Результат оцінювання
          своїх знань можна переглянути в довіниках «Слова та вирази» і «Теми», у яких всі слова, які ви відмітили як
          знаю, позначаються 👍. У «Теми» ви знайдете кількісне і % значення. Ви також можете формувати нові списки шляхом
          імпорту з сайту RWords або імпорту з CSV файлів.
        </p>
        <p className="text-base sm:text-lg lg:text-xl  mb-2">
          На сайті ви можете: створювати, редагувати, видаляти, імпортувати (CSV) і перекладати слова, вирази і речення,
          а також створювати і редагувати теми і групи тем. Після створення нових списків на сайті, ви можете
          імпортувати їх у застосунок.
        </p>
      </section>
      ...
      <ScreenBlock title="🧭 Основні екрани">
        ...
        <ScreenBlock title="🗣️ Слухати/Налаштування і інформація" img="/rwords_screens/sct_listenGreen.jpg">
