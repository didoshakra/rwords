  ...
  return (
    <main className="px-4 py-1 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <div className="flex justify-center mt-8 mb-4">
        <h1 className="inline-flex items-center gap-2 text-h1Text text-2xl sm:text-3xl lg:text-4xl font-bold">
      ...
      <section className="mb-6">
        ...
        <p className="text-base sm:text-lg lg:text-xl  mb-2">
          ...
          знаю, позначаються 👍. У «Теми» ви знайдете кількісне і % значення. Ви також можете формувати нові списки
          шляхом імпорту з сайту RWords або імпорту з CSV файлів.
        </p>
        <p className="text-base sm:text-lg lg:text-xl  mb-2">
