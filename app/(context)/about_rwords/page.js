    ...
    <main className="px-4 py-8 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <ScreenBlock title="🧭 Основні екрани">
        ...
        >
          ...
          {/* <h4 className="font-bold mb-1">📥 Використовуйте .csv файли для імпорту нових слів, виразів, речень</h4> */}
          <h4 className="font-bold mb-1">
            📥 Використовуйте .csv файли для імпорту нових слів, виразів, речень. Приклад структури можна
