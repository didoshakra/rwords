    ...
    <main className="px-4 py-8 max-w-4xl mx-auto text-hText dark:text-hTextD">
      ...
      <section className="mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            <div className="text-lg md:order-1">
              ...
              <ul className="text-base list-disc pl-10 mb-4">
                ...
                <li>🎙️ Налаштування голосових команд</li>
        ...
        <div className="mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <div className="text-lg md:order-2">
              ...
              <ul className="text-base list-disc pl-10 mb-4">
                <li>🗣️ основну мову</li>
                <li>🗣️ мову перекладу</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <div className="text-lg md:order-1">
              ...
              <ul className="text-base list-disc pl-10 mb-4">
                <li>🗣️ Додавайте(змінюйте) голосові команди до команд управління.</li>
                <li>🗣️ Додавайте нові коланди голосом: 🎤 голос, 🔁 повтор, ⚙️ інші параметри.</li>
                <li>🗣️ Налаштовуйте голосові команди під свій голос.</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <div className="text-lg md:order-1">
              ...
              <ul className="text-base list-disc pl-10 mb-4">
                ...
                <li>🗣️ Керуйте відтворенням слів за допомогою голосових команд і кнопок.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            <div className="text-lg md:order-1">
              <h3 className="text-base font-bold mb-1">Імпорт слів</h3>
              <ul className="text-base list-disc pl-10 mb-4">
                <li>
                  🎧 Щоб перемістити слово в списку потрібно його відмітити і тоді появиться кнопка &quot;Перемістити&quot;
                  при натисканні на яку появилься модальне віконечко для переміщення із стрілками вверх/вниз. Щоб
                  завершити переміщення натисніть кнопку Готово.
                </li>
              </ul>
            </div>
            <img
