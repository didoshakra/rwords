    ...
    <main className="px-4 py-8 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <section className="bg-pBg1 text-sm sm:text-base lg:text-lg mb-6 text-center py-10 px-6 rounded">
        {user ? (
          <Link
            href="/download"
            className="flex items-center justify-center gap-2 bg-green-600 text-pText dark:text-pTextD px-6 py-3 rounded hover:bg-green-700 transition "
          >
            <Image src="/images/home/RW_know_64.png" alt="RWords" width={24} height={24} priority />
            ...
            <div className="text-sm sm:text-base lg:text-lg">
              ...
              <ul className="list-disc pl-10">
                ...
                <li>
                  ...
                  супроводу слів з початку списку і « ▶️ Продовжити », яка запускає процес відтворення і
                  голосового супроводу слів з того слова яке прослуховувалось останнім якщо воно є в поточному списку.
                </li>
              </ul>
            </div>
            <img
