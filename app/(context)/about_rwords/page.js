        ...
        <div className="mt-8">
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            <ul className="list-disc pl-5 text-lg md:order-1">
              ...
              <li>❓ Підказка</li>
              <li>🔝 Середня панель :</li>
              <li>Злівва від мікровона напис "Не слухаю"-коли виключений мікрофон/коли мікрофон включений то відображаються розпізнані слова</li>
              <li>По центру-мікровон. Якщо мікрофон включений, то  напис "Не слухаю"-коли виключений мікрофон</li>
