          ...
          <div className="grid md:grid-cols-2 gap-4 items-center">
            ...
            <div className="text-lg md:order-2">
              ...
              <ul className="text-base list-disc pl-10 mb-4">
                ...
                <li>
                  🗣️ Вираз для озвучки кінця списку-це вираз який озвучить застосунок при досягненні початку списку
                </li>
                <li>
                  🗣️ Вираз для озвучки початку списку-це вираз який озвучить застосунок при досягненні початку списку
                ...
                <li>🗣️ Мова перекладу- мова на яку будуть перекладені слова</li>
              </ul>
            </div>
          </div>
        </div>
