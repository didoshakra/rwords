    ...
    <main className="px-4 py-8 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <section className="mb-6">
        ...
        <p className="text-base sm:text-lg lg:text-xl  mb-2">
          'У застосунку ви можете прослуховувати слова, вирази та речення з перекладом на вибрану мову із вбудованих
          списків або додавати власні слова й теми — як безпосередньо в застосунку, так і через сайт за допомогою
          імпорту. Під час прослуховування ви можете оцінювати свої знання натискаючи кнопки «Знаю» / «Не знаю», чи
          голосом, подаючи аналогічні голосові команди. Це формує персональні списки: слова, позначені як «Знаю», можна
          виключати з подальшого відтворення. Результат оцінювання своїх знань можна переглянути в довіниках "Слова та
          вирази" і "Теми", у яких всі слова, які ви відмітили як знаю, позначаються 👍. У "Теми" ви знайдете кількісне і
          % значення по темах'
        </p>
      </section>
      ...
      <ScreenBlock title="🧭 Основні екрани">
        ...
        <ScreenBlock
          ...
          img="/rwords_screens/wordsLlistButtons.jpg"
        ...
        <ScreenBlock title="📋🔀 Список слів-переміщення" img="/rwords_screens/wordsList.jpg">
          <h4 className="font-bold mb-1">Тут ви можете</h4>
          <ul className="list-disc pl-10 mb-4">
            <li>{`Щоб перемістити рядок потрібно: Відмітити слово ✅. а потім натиснути кнопку "Перемістити", яка появиться при відмітці тільки одного рядка-> внизу появиться віконце для переміщення рядка. І вже тоді стрілками  ↑/↓ перемісти вибраний рядок у потрібне місце. По завершенню переміщення вийти назад, натиснувши кнопку "Готово"`}</li>
          </ul>
