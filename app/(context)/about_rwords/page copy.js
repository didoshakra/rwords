...
export default function HowItWorks() {
  ...
  return (
    <main className="px-4 py-8 max-w-4xl mx-auto text-hText dark:text-hTextD ">
      <h1 className="inline-flex text-h1Text gap-2 justify-center items-center text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">
        <Image src="/images/home/RW_know_64.png" alt="RWords" width={24} height={24} priority />
        Що таке RWords?
      </h1>

      <section className="mb-6">
        <p className="  text-h2Text text-lg sm:text-xl lg:text-2xl font-semibold mb-2">
      ...
      <h1 className=" text-center font-bold text-h2Text text-xl sm:text-2xl lg:text-3xl  mb-2">
