    ...
    <main className="px-4 py-1 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      <ScreenBlock title="🧠 Головна ідея застосунку">
        <p>
          ...
          формуючи персоналізовані списки для подальшого прослуховування. Для комфортнішої роботи використовуються
          голосові команди.
        </p>
      </ScreenBlock>

      <ScreenBlock title="🧭 Застосунок має 4 основні екрани,">
        <div className="text-h3Text text-lg sm:text-xl lg:text-xl font-semibold text-center mb-1">
        ...
        <ul className="list-disc pl-10 space-y-2">
          ...
          <li>
            ...
            <div className="pl-6 mt-2">
              <div className="text-h3Text font-semibold mt-1">У 1-й частині екрану «Слухати» ви можете:</div>
              <ul className="list-disc pl-6">
                <li>🎙️🚫 включати/виключати мікрофон для того щоб додаток міг слухати голосові команди</li>
                <li>🎙️ налаштовувати голосові команди по кнопці/рядку</li>
              ...
              <div className="text-h3Text font-semibold mt-4">
                У 2-й частині екрану «Слухати» ви можете прослуховувати слова і:
              </div>
              <ul className="list-disc pl-6">
                <li>🗣️ для навігації по списку використовувати голосові команди або кнопки</li>
                <li>🎧 Оцінювати свої знання «✅ Знаю» / «❌ Не знаю»</li>
                ...
                <li>🔄 Повернутись на початок відтворення із збереженням останнього слова</li>
