...
export default function HowItWorks() {
  ...
  return (
    <main className="px-4 py-1 max-w-4xl mx-auto text-pText dark:text-pTextD">
      ...
      {/*  */}
      <ScreenBlock title="🧭 У застосунку ви можете:">
        <h3 className="text-h3Text text-lg sm:text-xl lg:text-xl font-semibold text-center mb-1">
          1. 🎧 Слухати слова, вирази та речення з перекладом на вибрану мову із вибраних вами списків
        </h3>
        <ul className="list-disc pl-10 space-y-2">
          ...
          <li>
            <strong>🎧 Слухати</strong> слова, вирази та речення з перекладом на вибрану мову із вибраних вами списків
