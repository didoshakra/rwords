      ...
      <main className="px-4 py-8 max-w-3xl mx-auto text-hText dark:text-hTextD">
        ...
        {/* <div className="bg-yellow-100 dark:bg-yellow-800 p-4 rounded-lg mb-6">
          <p className="text-md font-medium">
            📝 Щоб почати користуватись усіма можливостями сайту — <strong>зареєструйтесь або увійдіть</strong>.
          </p>
        </div> */}
        ...
        <section className="bg-yellow-100 text-center py-10 px-6 bg-blue-50">
          {user ? (
            <>
              ...
              <p className="mb-6 text-gray-700">Ви вже зареєстровані. Тепер ви можете користуватись усіма можливостями сайту.</p>
              <Link
                href="/download"
