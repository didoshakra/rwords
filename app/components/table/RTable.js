  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      ...
      setWorkData((prevData) => {
        ...
        // if (e.key === "ArrowDown" && currentIndex < prevData.length - 1) {
        ...
        //     const bottomPadding = 40 // змінюй під себе

        //     // якщо рядок повністю вище вікна — прокручуємо до верхньої межі
        //     if (rowTop < wrapperTop) {
        //       wrapper.scrollTop = rowTop
        //     }
        //     // якщо нижній край рядка вилазить за межу — прокручуємо так, щоб рядок став внизу
        //     else if (rowBottom + bottomPadding > wrapperBottom) {
        //       wrapper.scrollTop = rowBottom - wrapperHeight + bottomPadding
        //     }
        //   }
        // }, 10)
